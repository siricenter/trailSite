...
RSpec.describe "traditional_routes/edit", :type => :view do
  before(:each) do
  ...
  it "renders the edit traditional_route form" do
    render

    assert_select "form[action=?][method=?]", traditional_route_path(@traditional_route), "post" do
