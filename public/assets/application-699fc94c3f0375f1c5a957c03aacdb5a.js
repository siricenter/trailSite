...
(function() {
  ...
  /* globals */
	...
	var mapOptions;
	var markerArray = [];
	var dataUrl = "/regions/data/getJson";
	var mapCanvas;
	...
	/**
	* this will set the address of the json object to be retrieved
	*/
	function setDataUrl(url) {
		dataUrl = url;
		console.log("newUrl: " + dataUrl);
	}

	/**
	* inicialize starts the map, must call setDataUrl first to specify a url
	*/
      function initialize() {
      	var mapOptions = {
      	...
      	/*$.ajax({
					...
					if(textStatus == "success") {
						if (data instanceof Array) {
							console.log("Returned an array of objects");
							// create blank map then add the children markers
							createEmptyMap();
							loadMarkers(data);
						} else {
							console.log("Returned a json object");
							// createMap from object with parent node and children node
							createMap(data);
						}
					} else {
						// no data so just give us an empty map
						createEmptyMap();
					}
				});*/
      };
      ...
      /**
      * createMap will create the map based on the given json object. 
      * it requires an object with a parent node and children node
      * if the data is an array use createEmptyMap then pass to loadMarkers
      */
      function createMap(data){
      	parent = data.parent;
      	children = data.children;
      	console.log(children[0].latitude);
        mapOptions = {
	...
	*/
	...
	/**
	* loads markers from a jsonArray
	*/
	function loadMarkers(jsonArray) {
		console.log("Loading markers into map");
	}
